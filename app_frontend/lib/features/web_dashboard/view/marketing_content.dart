...
class MarketingContent extends StatelessWidget {
  ...
  const MarketingContent({super.key, required this.userName, required this.userEmail, this.userProfileImage});
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildPlaceholderContent(Icons.campaign, 'Marketing'),
        ],
      ),
    );
  }
