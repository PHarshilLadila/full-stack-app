...
class HelpSupportContent extends StatelessWidget {
  ...
  const HelpSupportContent({super.key, required this.userName, required this.userEmail, this.userProfileImage});
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          _buildPlaceholderContent(Icons.help, 'Help & Support'),
        ],
      ),
    );
  }
