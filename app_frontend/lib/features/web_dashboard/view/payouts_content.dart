...
class PayoutsContent extends StatelessWidget {
  ...
  const PayoutsContent({super.key, required this.userName, required this.userEmail, this.userProfileImage});
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildPlaceholderContent(Icons.account_balance_wallet, 'Payouts'),
        ],
      ),
    );
  }
