...
class AnalyticsContent extends StatelessWidget {
  ...
  const AnalyticsContent({super.key, required this.userName, required this.userEmail, this.userProfileImage});
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          _buildPlaceholderContent(Icons.analytics, 'Analytics'),
        ],
      ),
    );
  }
